import { d as __esmMin } from "../index.js";
import { c as init_fetch_blob, i as init_esm_min, n as FormData, r as formDataToBlob, s as Blob, t as init_from } from "./from-BpZ4SG48.js";
...
async function consumeBody(data) {
	...
	/* c8 ignore next 3 */
	if (!(body instanceof Pe)) return Buffer$1.alloc(0);
	const accum = [];
	let accumBytes = 0;
	try {
...
var init_body = __esmMin((() => {
	...
	Body = class {
		constructor(body, { size = 0 } = {}) {
			...
			let stream = body;
			if (Buffer$1.isBuffer(body)) stream = Pe.Readable.from(body);
		...
		*/
		...
		async formData() {
			...
			const { toFormData } = await import("./multipart-parser-B6L6s4Cj.js");
