...
## 2026-07-21T15:49:59Z

You are the Project Orchestrator. Your mission is to generate a comprehensive architecture and codebase map for the `omni` project (Electron + Vite + React/TS application) and output it to `ARCHITECTURE_MAP.md` at the workspace root `/Users/harshithpasupuleti/code/omni/ARCHITECTURE_MAP.md`.
...
Please decompose this goal into milestones, create your `plan.md` and `progress.md` in your working directory, spawn explorer and worker agents to investigate the codebase and write the architecture documentation, and notify me when completed.
