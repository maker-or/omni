...
import {
  ...
  R as REROUTABLE_STATUS_CODES,
  a as REROUTE_DIRECTIVE_HEADER,
  i as isPropagatingHint,
  g as getPropagationHint$1,
  M as MissingMediaQueryDirective,
  b as NoMatchingImport,
  e as escapeHTML,
  c as bufferPropagatedHead,
  f as isHeadAndContent,
  h as isRenderTemplateResult,
  O as OnlyResponseCanBeReturned,
  j as isPromise,
  p as promiseWithResolvers,
  k as encoder,
  l as ResponseSentError,
  m as chunkToByteArray,
  n as chunkToString,
  o as chunkToByteArrayOrString,
  t as toAttributeString,
  q as markHTMLString,
  r as renderSlotToString,
  u as maybeRenderHead,
  v as containsServerDirective,
  F as Fragment,
  w as renderChild,
  x as renderSlots,
  S as ServerIslandComponent,
  y as createAstroComponentInstance,
  z as Renderer,
  B as NoMatchingRenderer,
  C as formatList,
  D as NoClientOnlyHint,
  G as internalSpreadAttributes,
  H as voidElementNames,
  I as renderTemplate,
  J as createRenderInstruction,
  K as renderElement$1,
  L as SlotString,
  P as mergeSlotInstructions,
  Q as HTMLString,
  T as isHTMLString,
  U as isRenderInstruction,
  V as isAstroComponentInstance,
  W as isRenderInstance,
  X as renderCspContent,
  Y as isNode,
  Z as isDeno,
  _ as addAttribute,
  $ as decryptString,
  a0 as createSlotValueFromString,
  a1 as DEFAULT_404_COMPONENT,
  a2 as DEFAULT_404_ROUTE,
  a3 as default404Instance,
  a4 as removeTrailingForwardSlash,
  a5 as getParams,
  a6 as prependForwardSlash,
  a7 as decodeKey,
  a8 as UnableToLoadLogger,
  a9 as RouteCache,
  s as sequence,
  aa as ActionNotFoundError,
  ab as ReservedSlotName,
  ac as pipelineSymbol,
  ad as shouldAppendForwardSlash,
  ae as REDIRECT_STATUS_CODES,
  af as ActionsReturnedInvalidDataError,
  ag as ROUTE_TYPE_HEADER,
  ah as appendForwardSlash,
  ai as i18nNoLocaleFoundInPath,
  aj as MiddlewareNoDataOrNextCalled,
  ak as MiddlewareNotAResponse,
  al as CacheNotEnabled,
  am as ASTRO_ERROR_HEADER,
  an as REWRITE_DIRECTIVE_HEADER_KEY,
  ao as REWRITE_DIRECTIVE_HEADER_VALUE,
  ap as collapseDuplicateSlashes,
  aq as ForbiddenRewrite,
  ar as copyRequest,
  as as setOriginPathname,
  at as isRoute404,
  au as isRoute500,
  av as joinPaths,
  aw as collapseDuplicateLeadingSlashes,
  ax as originPathnameSymbol,
  ay as generateCspDigest,
  az as ASTRO_GENERATOR,
  aA as PrerenderClientAddressNotAvailable,
  aB as ClientAddressNotAvailable,
  aC as StaticClientAddressNotAvailable,
  aD as routeHasHtmlExtension,
  aE as getCustom404Route,
  aF as appSymbol,
  aG as getProps,
  aH as fetchStateSymbol,
  aI as AstroResponseHeadersReassigned,
  aJ as responseSentSymbol$1,
  aK as getOriginPathname,
  aL as LocalsReassigned,
  aM as INTERNAL_RESPONSE_HEADERS,
  aN as isInternalPath,
  aO as collapseDuplicateTrailingSlashes,
  aP as hasFileExtension,
  aQ as removeLeadingForwardSlash,
  aR as getRouteGenerator,
  aS as SessionStorageInitError,
  aT as SessionStorageSaveError,
  aU as LocalsNotAnObject,
  aV as clientAddressSymbol,
  aW as fileExtension,
  aX as slash,
  aY as routeIsRedirect,
  aZ as routeIsFallback,
  a_ as getFallbackRoute,
  a$ as findRouteToRewrite,
...
class Pipeline {
  ...
  constructor(
    ...
    sessionDriver = manifest2.sessionDriver,
    cacheProvider = manifest2.cacheProvider,
    cacheConfig = manifest2.cacheConfig,
    serverIslands = manifest2.serverIslandMappings,
  ) {
    this.logger = logger;
...
const middlewareSecret = "ee734bf1-8839-4878-8a40-e5644f24e273";
...
const __vite_import_meta_env__$1 = {
  ...
  MODE: "production",
  PROD: true,
  PUBLIC_CLERK_PUBLISHABLE_KEY: "pk_test_c3dlZXBpbmctbW90aC01Mi5jbGVyay5hY2NvdW50cy5kZXYk",
  SITE: void 0,
  SSR: true,
};
...
function isInputError(error2) {
  return (
    ...
    error2 != null &&
    "type" in error2 &&
    error2.type === "AstroActionInputError" &&
    "issues" in error2 &&
  ...
  if (res.type === "error") {
    ...
    if (
      Object.assign(__vite_import_meta_env__$1, {
        _: "/Users/harshithpasupuleti/code/omni/marketing/node_modules/.bin/astro",
      })?.PROD
    ) {
      ...
      handler: async () => {
        ...
        try {
          ...
          if (
            ...
            "name" in error2 &&
            typeof error2.name === "string" &&
            error2.name === ActionNotFoundError.name
          ) {
...
class FetchState {
  ...
  async createResult(mod, ctx) {
    ...
    const shouldInjectCspMetaTags =
      this.shouldInjectCspMetaTags ?? manifest2.shouldInjectCspMetaTags;
    ...
    const componentMetadata =
      (await pipeline.componentMetadata(routeData)) ?? manifest2.componentMetadata;
...
class BaseApp {
  ...
  #warnMissingFeatures() {
    ...
    if (
      manifest2.routes.some((r) => r.routeData.type === "redirect") &&
...
const serializedData = [
  ...
  },
  {
    ...
    routeData: {
      ...
      isIndex: false,
      type: "page",
      pattern: "^\\/auth\\/complete\\/?$",
      segments: [
        [{ content: "auth", dynamic: false, spread: false }],
        [{ content: "complete", dynamic: false, spread: false }],
      ],
      params: [],
      component: "src/pages/auth/complete.astro",
  ...
  },
  {
    ...
    routeData: {
      ...
      type: "page",
      pattern: "^\\/auth\\/?$",
      segments: [[{ content: "auth", dynamic: false, spread: false }]],
      params: [],
...
const _page0 = () => import("./generic_DHFYnAVX.mjs").then((n) => n.g);
const _page1 = () => import("./complete_C6pzCqZ6.mjs");
const _page2 = () => import("./auth_OvAkQb48.mjs");
const _page3 = () => import("./index_DdKpXDLo.mjs");
const pageMap = /* @__PURE__ */ new Map([
  ["node_modules/astro/dist/assets/endpoint/generic.js", _page0],
  ["src/pages/auth/complete.astro", _page1],
  ["src/pages/auth.astro", _page2],
  ["src/pages/index.astro", _page3],
]);
const _manifest = deserializeManifest({
  rootDir: "file:///Users/harshithpasupuleti/code/omni/marketing/",
  cacheDir: "file:///Users/harshithpasupuleti/code/omni/marketing/node_modules/.astro/",
  outDir: "file:///Users/harshithpasupuleti/code/omni/marketing/dist/",
  srcDir: "file:///Users/harshithpasupuleti/code/omni/marketing/src/",
  publicDir: "file:///Users/harshithpasupuleti/code/omni/marketing/public/",
  buildClientDir: "file:///Users/harshithpasupuleti/code/omni/marketing/dist/client/",
  buildServerDir: "file:///Users/harshithpasupuleti/code/omni/marketing/dist/server/",
  ...
  routes: [
    ...
    },
    {
      file: "",
      links: [],
      scripts: [{ type: "external", value: "_astro/page.BoFyXAhM.js" }],
      styles: [],
      routeData: {
        route: "/_image",
        component: "node_modules/astro/dist/assets/endpoint/generic.js",
      ...
      styles: [
        {
          type: "inline",
          content:
            '.ambient-pixel-field[data-astro-cid-z7e2xysf]{position:absolute;inset:0;width:100%;height:100%;background:transparent;overflow:hidden;pointer-events:none;user-select:none;z-index:0}.glow-container[data-astro-cid-z7e2xysf]{position:absolute;inset:0;pointer-events:none;overflow:hidden;z-index:0}.glow-field[data-astro-cid-z7e2xysf]{position:absolute;border-radius:9999px;filter:blur(100px)}.glow-left[data-astro-cid-z7e2xysf]{width:60%;height:60%;left:10%;bottom:-20%;background:radial-gradient(circle,#545cff 0%,transparent 70%);opacity:.03}.glow-right[data-astro-cid-z7e2xysf]{width:50%;height:50%;right:15%;bottom:-10%;background:radial-gradient(circle,#545cff 0%,transparent 70%);opacity:.02;filter:blur(120px)}@keyframes pulse-left{0%,to{opacity:.015;transform:scale(1) translateY(0)}50%{opacity:.04;transform:scale(1.05) translateY(-6px)}}@keyframes pulse-right{0%,to{opacity:.01;transform:scale(1.04) translateY(0)}50%{opacity:.03;transform:scale(.96) translateY(8px)}}.animate-glow-left[data-astro-cid-z7e2xysf]{animation:pulse-left 30s ease-in-out infinite}.animate-glow-right[data-astro-cid-z7e2xysf]{animation:pulse-right 45s ease-in-out infinite}.pixel-grid[data-astro-cid-z7e2xysf]{position:absolute;inset:0;pointer-events:none;z-index:10;display:grid;justify-content:center;align-content:end;-webkit-mask-image:linear-gradient(to top,rgba(0,0,0,1) 0%,rgba(0,0,0,0) calc(var(--fadeStart) * 100%),rgba(0,0,0,0) 100%);mask-image:linear-gradient(to top,#000,#0000 calc(var(--fadeStart) * 100%) 100%)}html,body{margin:0;width:100%;height:100%}body{font-family:"Averia Serif Libre",serif;background:#171717;color:#e5e7eb;position:relative}.shell{position:relative;z-index:10;min-height:100vh;display:grid;place-items:center;padding:32px;box-sizing:border-box}\n.shell[data-astro-cid-n2p7yvsj]{position:relative;z-index:10;min-height:100vh;display:grid;place-items:center;padding:32px;box-sizing:border-box}.card[data-astro-cid-n2p7yvsj]{width:min(560px,100%);border:1px solid rgba(255,255,255,.08);background:#080d1ab8;backdrop-filter:blur(16px);border-radius:24px;padding:32px;box-shadow:0 30px 80px #00000059}h1[data-astro-cid-n2p7yvsj]{margin:0 0 12px}p[data-astro-cid-n2p7yvsj]{color:#e5e7ebb8;margin:0}\n',
        },
      ],
      routeData: {
        route: "/auth/complete",
      ...
      styles: [
        {
          type: "inline",
          content:
            '.ambient-pixel-field[data-astro-cid-z7e2xysf]{position:absolute;inset:0;width:100%;height:100%;background:transparent;overflow:hidden;pointer-events:none;user-select:none;z-index:0}.glow-container[data-astro-cid-z7e2xysf]{position:absolute;inset:0;pointer-events:none;overflow:hidden;z-index:0}.glow-field[data-astro-cid-z7e2xysf]{position:absolute;border-radius:9999px;filter:blur(100px)}.glow-left[data-astro-cid-z7e2xysf]{width:60%;height:60%;left:10%;bottom:-20%;background:radial-gradient(circle,#545cff 0%,transparent 70%);opacity:.03}.glow-right[data-astro-cid-z7e2xysf]{width:50%;height:50%;right:15%;bottom:-10%;background:radial-gradient(circle,#545cff 0%,transparent 70%);opacity:.02;filter:blur(120px)}@keyframes pulse-left{0%,to{opacity:.015;transform:scale(1) translateY(0)}50%{opacity:.04;transform:scale(1.05) translateY(-6px)}}@keyframes pulse-right{0%,to{opacity:.01;transform:scale(1.04) translateY(0)}50%{opacity:.03;transform:scale(.96) translateY(8px)}}.animate-glow-left[data-astro-cid-z7e2xysf]{animation:pulse-left 30s ease-in-out infinite}.animate-glow-right[data-astro-cid-z7e2xysf]{animation:pulse-right 45s ease-in-out infinite}.pixel-grid[data-astro-cid-z7e2xysf]{position:absolute;inset:0;pointer-events:none;z-index:10;display:grid;justify-content:center;align-content:end;-webkit-mask-image:linear-gradient(to top,rgba(0,0,0,1) 0%,rgba(0,0,0,0) calc(var(--fadeStart) * 100%),rgba(0,0,0,0) 100%);mask-image:linear-gradient(to top,#000,#0000 calc(var(--fadeStart) * 100%) 100%)}html,body{margin:0;width:100%;height:100%}body{font-family:"Averia Serif Libre",serif;background:#171717;color:#e5e7eb;position:relative}.shell{position:relative;z-index:10;min-height:100vh;display:grid;place-items:center;padding:32px;box-sizing:border-box}\n.hero[data-astro-cid-5ndk7oiz]{display:flex;justify-content:center;align-items:center}.actions[data-astro-cid-5ndk7oiz]{display:flex;gap:16px}.actions[data-astro-cid-5ndk7oiz] button{padding:12px 24px;font-size:15px;font-weight:600;border-radius:12px;border:1px solid rgba(255,255,255,.08);background:#ffffff0f;color:#fff;cursor:pointer;transition:all .2s ease}.actions[data-astro-cid-5ndk7oiz] button:hover{background:#ffffff1f;border-color:#ffffff29;transform:translateY(-1px)}\n',
        },
      ],
      routeData: {
        route: "/auth",
      ...
      styles: [
        {
          type: "inline",
          content:
            '.ambient-pixel-field[data-astro-cid-z7e2xysf]{position:absolute;inset:0;width:100%;height:100%;background:transparent;overflow:hidden;pointer-events:none;user-select:none;z-index:0}.glow-container[data-astro-cid-z7e2xysf]{position:absolute;inset:0;pointer-events:none;overflow:hidden;z-index:0}.glow-field[data-astro-cid-z7e2xysf]{position:absolute;border-radius:9999px;filter:blur(100px)}.glow-left[data-astro-cid-z7e2xysf]{width:60%;height:60%;left:10%;bottom:-20%;background:radial-gradient(circle,#545cff 0%,transparent 70%);opacity:.03}.glow-right[data-astro-cid-z7e2xysf]{width:50%;height:50%;right:15%;bottom:-10%;background:radial-gradient(circle,#545cff 0%,transparent 70%);opacity:.02;filter:blur(120px)}@keyframes pulse-left{0%,to{opacity:.015;transform:scale(1) translateY(0)}50%{opacity:.04;transform:scale(1.05) translateY(-6px)}}@keyframes pulse-right{0%,to{opacity:.01;transform:scale(1.04) translateY(0)}50%{opacity:.03;transform:scale(.96) translateY(8px)}}.animate-glow-left[data-astro-cid-z7e2xysf]{animation:pulse-left 30s ease-in-out infinite}.animate-glow-right[data-astro-cid-z7e2xysf]{animation:pulse-right 45s ease-in-out infinite}.pixel-grid[data-astro-cid-z7e2xysf]{position:absolute;inset:0;pointer-events:none;z-index:10;display:grid;justify-content:center;align-content:end;-webkit-mask-image:linear-gradient(to top,rgba(0,0,0,1) 0%,rgba(0,0,0,0) calc(var(--fadeStart) * 100%),rgba(0,0,0,0) 100%);mask-image:linear-gradient(to top,#000,#0000 calc(var(--fadeStart) * 100%) 100%)}html,body{margin:0;width:100%;height:100%}body{font-family:"Averia Serif Libre",serif;background:#171717;color:#e5e7eb;position:relative}.shell{position:relative;z-index:10;min-height:100vh;display:grid;place-items:center;padding:32px;box-sizing:border-box}\nsection[data-astro-cid-j7pv25f6]{display:flex;flex-direction:column;align-items:center;text-align:center}.card[data-astro-cid-j7pv25f6]{width:min(560px,100%);border:1px solid rgba(255,255,255,.08);background:#17171799;backdrop-filter:blur(16px);border-radius:24px;padding:40px;box-shadow:0 30px 80px #00000059;text-align:center;display:flex;flex-direction:column;align-items:center;gap:16px}h1[data-astro-cid-j7pv25f6]{font-size:96px;font-weight:700;margin:0;background:linear-gradient(135deg,#fff,#a3a3a3);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;letter-spacing:-.02em;line-height:1.1}h3[data-astro-cid-j7pv25f6]{font-size:48px;font-weight:400;margin:16px 0 0;color:#ffffff73;line-height:1.25;letter-spacing:-.02em}.waitlist-btn[data-astro-cid-j7pv25f6]{font-family:inherit;font-size:18px;font-weight:600;padding:14px 28px;border-radius:99px;border:1px solid rgba(255,255,255,.12);background:#ffffff14;color:#fff;cursor:pointer;backdrop-filter:blur(12px);transition:all .2s cubic-bezier(.16,1,.3,1);margin-top:32px;box-shadow:0 4px 20px #0003}.waitlist-btn[data-astro-cid-j7pv25f6]:hover{background:#ffffff26;border-color:#ffffff40;transform:translateY(-2px);box-shadow:0 8px 30px #ffffff0d}.waitlist-btn[data-astro-cid-j7pv25f6]:active{transform:translateY(0)}.waitlist-dialog[data-astro-cid-j7pv25f6]{border:none;background:transparent;padding:0;margin:auto;overflow:visible}.waitlist-dialog[data-astro-cid-j7pv25f6]::backdrop{background:#000000b3;backdrop-filter:blur(8px)}.dialog-content[data-astro-cid-j7pv25f6]{position:relative;background:#171717;border:1px solid rgba(255,255,255,.08);border-radius:24px;padding:40px 24px 24px;box-shadow:0 30px 80px #00000059;width:min(480px,90vw);display:flex;flex-direction:column;align-items:center;box-sizing:border-box}.close-btn[data-astro-cid-j7pv25f6]{position:absolute;top:16px;right:16px;background:transparent;border:none;color:#fff6;font-size:28px;cursor:pointer;line-height:1;padding:4px;transition:color .15s ease}.close-btn[data-astro-cid-j7pv25f6]:hover{color:#fff}p[data-astro-cid-j7pv25f6]{font-size:16px;color:#ffffffb3;margin:0;line-height:1.5}.badge[data-astro-cid-j7pv25f6]{display:inline-block;padding:6px 12px;font-size:12px;font-weight:500;color:#fff6;background:#ffffff0a;border:1px solid rgba(255,255,255,.08);border-radius:99px;margin-top:8px}\n',
        },
      ],
      routeData: {
        route: "/",
  ...
  entryModules: {
    "astro:scripts/before-hydration.js": "_astro/astro_scripts/before-hydration.js.Dd4FZwqi.js",
    "\u0000virtual:astro:actions/noop-entrypoint": "chunks/noop-entrypoint_BCpcfjRN.mjs",
    "\u0000virtual:astro:middleware": "virtual_astro_middleware.mjs",
    "\u0000virtual:astro:session-driver": "chunks/_virtual_astro_session-driver_Czueip2h.mjs",
    "\u0000virtual:astro:server-island-manifest":
      "chunks/_virtual_astro_server-island-manifest_BNqiWpu6.mjs",
    "astro/entrypoints/prerender": "prerender-entry.C9rRHKyA.mjs",
    "@astrojs/vercel/entrypoint": "entry.mjs",
    "\u0000virtual:astro:page:src/pages/auth/complete@_@astro": "chunks/complete_C6pzCqZ6.mjs",
    "\u0000virtual:astro:page:src/pages/auth@_@astro": "chunks/auth_OvAkQb48.mjs",
    "\u0000virtual:astro:page:src/pages/index@_@astro": "chunks/index_DdKpXDLo.mjs",
    "/Users/harshithpasupuleti/code/omni/marketing/node_modules/astro/dist/assets/services/sharp.js":
      "chunks/sharp_zgvRmSdi.mjs",
    "/Users/harshithpasupuleti/code/omni/marketing/node_modules/@clerk/astro/components/control/ShowCSR.astro?astro&type=script&index=0&lang.ts":
      "_astro/ShowCSR.astro_astro_type_script_index_0_lang.CXNm3axh.js",
    "/Users/harshithpasupuleti/code/omni/marketing/node_modules/@clerk/astro/components/interactive/UserButton/UserButtonMenuItems.astro?astro&type=script&index=0&lang.ts":
      "_astro/UserButtonMenuItems.astro_astro_type_script_index_0_lang.DjJJDhXb.js",
    "/Users/harshithpasupuleti/code/omni/marketing/src/components/AmbientPixelField.astro?astro&type=script&index=0&lang.ts":
      "_astro/AmbientPixelField.astro_astro_type_script_index_0_lang.B5t1sohL.js",
    "/Users/harshithpasupuleti/code/omni/marketing/src/pages/index.astro?astro&type=script&index=0&lang.ts":
      "_astro/index.astro_astro_type_script_index_0_lang.CzezoYZ5.js",
    "astro:scripts/page.js": "_astro/page.BoFyXAhM.js",
    "\u0000astro:transitions/client": "_astro/client.LtOrxvrW.js",
  },
  inlinedScripts: [
    [
      "/Users/harshithpasupuleti/code/omni/marketing/node_modules/@clerk/astro/components/interactive/UserButton/UserButtonMenuItems.astro?astro&type=script&index=0&lang.ts",
      'class e extends HTMLElement{constructor(){super()}}customElements.define("clerk-user-button-menu-items",e);',
    ],
    [
      "/Users/harshithpasupuleti/code/omni/marketing/src/components/AmbientPixelField.astro?astro&type=script&index=0&lang.ts",
      'function u(){document.querySelectorAll(".ambient-pixel-field").forEach(e=>{const n=e.querySelector(".pixel-grid");if(!n)return;const o=parseFloat(e.getAttribute("data-pixel-size")||"6"),s=parseFloat(e.getAttribute("data-gap")||"4"),x=parseFloat(e.getAttribute("data-intensity")||"0.2"),g=Math.random()*1e3;function m(c,l){const i=c+g,a=l+g,r=Math.sin(i*12.9898+a*78.233)*43758.5453123;return(r-Math.floor(r))*x}function h(){const c=e.clientWidth,l=e.clientHeight,i=o+s,a=Math.max(0,Math.floor((c+s)/i)),r=Math.max(0,Math.floor((l+s)/i));n.style.gridTemplateColumns=`repeat(${a}, ${o}px)`,n.style.gridTemplateRows=`repeat(${r}, ${o}px)`,n.style.gap=`${s}px`,n.innerHTML="";const y=document.createDocumentFragment();for(let p=0;p<r;p++)for(let d=0;d<a;d++){const b=m(p,d),t=document.createElement("div");t.style.width=`${o}px`,t.style.height=`${o}px`,t.style.borderRadius="1px",t.style.opacity=String(b),t.style.backgroundColor="rgba(255, 255, 255, 0.12)",t.style.flexShrink="0",t.style.transition="opacity 300ms",y.appendChild(t)}n.appendChild(y)}h(),new ResizeObserver(()=>{h()}).observe(e)})}u();document.addEventListener("astro:page-load",u);',
    ],
    [
      "/Users/harshithpasupuleti/code/omni/marketing/src/pages/index.astro?astro&type=script&index=0&lang.ts",
      'const e=document.getElementById("waitlist-trigger"),t=document.getElementById("waitlist-dialog"),i=document.getElementById("waitlist-close");e&&t&&i&&(e.addEventListener("click",()=>{t.showModal()}),i.addEventListener("click",()=>{t.close()}),t.addEventListener("click",c=>{c.target===t&&t.close()}));',
    ],
  ],
  assets: [
    "/favicon.ico",
    "/favicon.svg",
    "/_astro/ShowCSR.astro_astro_type_script_index_0_lang.CXNm3axh.js",
    "/_astro/client.LtOrxvrW.js",
    "/_astro/external-DHTxQaok.BzGBULKT.js",
    "/_astro/index.DCp8qI1k.js",
    "/_astro/page.BoFyXAhM.js",
    "/_astro/astro_scripts/before-hydration.js.Dd4FZwqi.js",
    "/_astro/page.BoFyXAhM.js",
  ],
  ...
  allowedDomains: [],
  key: "M6OAYnjG7OEXoV1wwgoRZDZ8b+f6DeeEwgsn4BWkMPk=",
  image: {},
